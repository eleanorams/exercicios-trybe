const {myRemove, myFizzBuzz, mapString, encode, decode, techList, hydrate} = require('./exercicio1');

describe('testa a função myRemove', () => {
  it('realiza operações e verifica se é retornado o valor esperado', () => {
...
describe('testa a função myFizzBuzz', () => {
  test('verifica se o número da função é divisível por 3, 5 ou ambos e se é um número', () => {
    expect(myFizzBuzz(15)).toBe('fizzbuzz');
    expect(myFizzBuzz(3)).toBe('fizz');
    expect(myFizzBuzz(5)).toBe('buzz');
    expect(myFizzBuzz(2)).toBe(2);
    expect(myFizzBuzz('e')).toBe(false);
  });
});
